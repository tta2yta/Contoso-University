        ...
        public async Task<IActionResult> Index(int? id, int? courseID)
        {
            ...
            viewModel.Instructors = await _context.Instructors
                ...
                .Include(i => i.CourseAssignments)
                  .ThenInclude(i => i.Cousre)
                  .ThenInclude(i => i.Enrollments)
                  .ThenInclude(i => i.Student)
                  .Include(i => i.CourseAssignments)
                  .ThenInclude(i => i.Cousre)
                  .ThenInclude(i => i.Department).AsNoTracking().OrderBy(i => i.LastName)
                  .ToListAsync();
            if(id!=null)
            {
                ViewData["InstructorID"] = id.Value;
                Instructor instructor = viewModel.Instructors.Where(i => i.ID == id.Value).Single();
                viewModel.Courses = instructor.CourseAssignments.Select(s => s.Cousre);
            }
